...
import com.gb.kotlin_1728_2_1.model.utils.YANDEX_API_URL_END_POINT
...
class DetailsViewModel(
    ...
    fun getWeatherFromRemoteServer(lat:Double, lon:Double) {
        ...
        repositoryImpl.getWeatherFromServer(YANDEX_API_URL + YANDEX_API_URL_END_POINT + "?lat=${lat}&lon=${lon}"
            , callback)
    }
